...
for j = 1:backhaul_size
    ...
    flow_list(K+1:K+num_core_peer,3)=...
        round(unifrnd(DualLayerNetwork.DOWN_DEMAND_MIN,DualLayerNetwork.DOWN_DEMAND_MAX,...
        num_core_peer,1));
    K = K+num_core_peer;
    %% uplink
    ...
    flow_list(K+1:K+num_core_peer,3)=...
        round(unifrnd(DualLayerNetwork.UP_DEMAND_MIN,DualLayerNetwork.UP_DEMAND_MAX,...
        num_core_peer,1));
    K = K+num_core_peer;
end
...
for i = 1:core_size
    ...
    flow_list(K+1:K+ld,3)=round(unifrnd(DualLayerNetwork.INTRA_DEMAND_MIN0,...
        DualLayerNetwork.INTRA_DEMAND_MAX0,ld,1));
    K = K+ld;
end
flow_list = flow_list(1:K,:);
end